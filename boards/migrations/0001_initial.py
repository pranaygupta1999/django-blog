# Generated by Django 2.1.5 on 2019-01-14 16:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('boards', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='topic', to='boards.Board')),
                ('starter', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='topic', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='post',
